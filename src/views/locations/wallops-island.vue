  ...
  <div class="container">
    ...
    <div class="profile-head">
      <div class="bio">
        ...
        >
        <div class="name">
          <h1 class="h2">Wallops Flight Facility</h1>
    ...
    <div class="profile-body pb-4">
      ...
      <div class="body-bio">
        ...
        <div class="foobar">
          ...
          <p class="bar">
            Wallops Flight Facility, located on the eastern shore of Virginia, is a NASA-run launch site that supports a wide range of scientific, sounding rocket, and orbital missions. It serves as an important East Coast hub for suborbital research, technology development, and commercial launches.
          </p>
        </div>
        <figure>
          <figcaption>Quick Facts:</figcaption>
          <ul>
            <li>Wallops has launched over 16,000 rockets since 1945, many of which were critical milestones in sounding rocket and satellite technology.</li>
            <li>It played a key role in the Apollo program by testing components of the Lunar Module.</li>
            <li>Wallops supports frequent resupply missions to the International Space Station and continues to be a vital center for NASA’s scientific and educational payloads.</li>
          </ul>
        </figure>
      </div>
    </div>
    ...
    <div class="profile-feed mb-4">
      ...
      <div v-else-if="galleryImages.length" class="image-grid">
        <img 
          ...
          class="img" 
          :alt="item.data?.[0]?.title || 'Wallops image'"
          loading="lazy"
        />
      </div>
...
const zoom = 11
const center = [37.93751126741556, -75.47042545896504]
const markerLatLng = [37.93751126741556, -75.47042545896504]
const content = 'NASA Wallops Flight Facility'
...
const fetchImages = async () => {
  const computeString = "Wallops Flight Facility".replace(/ /g, '%20')
  const image_url = `https://images-api.nasa.gov/search?q=${computeString}&page=1`
  
  console.log('Fetching NASA images for Wallops:', image_url)
  ...
  try {
    ...
    console.error("Error fetching NASA images for Wallops:", error)
    images.value = null
  } finally {
    loading.value = false
  }
