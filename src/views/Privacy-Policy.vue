    ...
    <div class="container-fluid text-center my-5">
      ...
      <div class="body my-4 text-left">
        ...
        <div class="row mx-2">
            ...
            <hr>
            <p>Update: For the forseeable future, Google Adsense has been disabled.  I felt like it sort of cheapened the experience of the site, so I have ditched it in favor of Buy Me a Coffee instead.  This way you can directly support the project (if you'd like) without selling your soul to the devil (Google, I'm kidding, kind of.)</p>
        </div>
        <br>
        ...
        <div class="row mx-2">
            ...
            <p>If you have any other questions, would like to help the site grow or simply want to talk about the final frontier - you can use the contact form on the home page, or follow on Twitter <a href="https://twitter.com/rocketdownrange" class="link" target="_blank" rel="noopener">(<i class="fab fa-twitter"></i> @RocketDownrange )</a>.  We look forward to exploring with you! </p>
        </div>
        <br>
