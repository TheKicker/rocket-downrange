  ...
  <div>
    ...
    <div class="mx-auto container">
      <div class="profile-head">
        <div class="bio">
          <img
            src="@/assets/rover/PERCY.png"
            class="profile-image"
            alt="Rocket Downrange Rover profile image for the 'Perseverance' Mars Rover"
          />
          <div class="name">
            <h1 class="roverName">Perseverance</h1>
            <p class="roverLocation">
              <i class="fas fa-map-marker-alt mr-2"></i> Jezero Crater, Mars
            </p>
          </div>
        </div>
        <div class="stats">
          ...
          <div class="stats-item">
            <p class="stats-status">25.8 (41.6)</p>
      ...
      <div class="profile-body">
        ...
        <div class="body-bio">
          ...
          <div class="foobar">
            ...
            <p class="bar">
              Nicknamed "Percy", this rover is similar to its predecessor,
              <router-link to="/curiosity">Curiosity</router-link> — however it
              adds a variety of awesome upgrades to test in the martian landscape
              like oxygen production and a detachable helicopter. This biography
              will grow as Percy continues its mission to seek out evidence of
              microbial life and collecting rock/soil samples for return.
            </p>
          </div>
          <div class="foobar">
          ...
          <div class="foobar text-center">
            <a
              ...
              rel="noopener"
            >
              <i class="fab fa-twitter"></i> Follow Perseverance on Twitter
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="profile-feed" v-if="results.photos && results.photos.length > 0">
        ...
        >
          <VLazyImage
            :src="result.img_src"
            :alt="'Photo id#' + result.id + ' taken by Perseverance Rover in the Jezero Crater on Mars'"
            class="img"
          />
        </a>
      </div>
...
export default {
  ...
  async mounted() {
    ...
    const api_key = process.env.VUE_APP_APOD_KEY; // Make sure this is set in your .env file
    ...
    try {
      ...
      console.log(`Loaded ${this.results.photos.length} latest Perseverance photos`);
    } catch (error) {
      console.error("Failed to fetch Perseverance photos:", error);
      this.results = { photos: [] };
    }
  },
  metaInfo: {
    ...
    meta: [
      ...
      {
        name: "keywords",
        content: "Rocket, Downrange, NASA, JPL, Mars, Rovers, Perseverance",
      },
      // OpenGraph & Twitter meta tags (unchanged)
      ...
      { name: "twitter:title", content: "Rocket Downrange | Perseverance Rover" },
      {
...
.cover {
  ...
  background-image: url("https://cloudflare1.360gigapixels.com/pano/bodrov/01828739_0046-0-tif/equirect_crop_3_1/6.jpg");
