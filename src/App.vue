<template>
  <div id="app" v-cloak>
    <div id="marqueecontainer">
      <p id="marquee"> LOVE ROCKET DOWNRANGE? SUPPORT THE PROJECT AND <a class="marquee-btn" href="https://github.com/TheKicker/rocket-downrange/stargazers" target="_blank" rel="noopener"><i class="fas fa-star"></i>  STAR ON GITHUB 7</a></p>
    </div>
