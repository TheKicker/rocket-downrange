        ...
        <div class="row mx-1">
          <div class="col-md-5 col-sm-12 text-center">
            <img
              ...
              this.results.results[0].mission.name != null ||
            undefined
              ? 'Fireflys next launch / mission is named ' + this.results.results[0].mission.name
...
<script>
var url =
  "https://ll.thespacedevs.com/2.0.0/launch/upcoming/?format=json&rocket__configuration__manufacturer__name__icontains=Firefly&limit=1";
