      ...
      <div class="card-body">
        ...
        <div class="row mx-1">
          <div class="col-md-5 col-sm-12 text-center">
            <img
              src="https://rocketdownrange.com/firefly-vertical.png"
              class="img-fluid"
              alt="Firefly Upcoming Launch Mission"
            />
          </div>
...
<script>
var url =
  "https://ll.thespacedevs.com/2.0.0/launch/upcoming/?format=json&limit=1&rocket__configuration__manufacturer__name__icontains=Firefly";
