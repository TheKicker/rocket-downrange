      ...
      <div class="card-body p-3 p-md-6 m-md-3">
        ...
        <div class="container">
          ...
          <div class="my-4 row justify-content-center">
            <a href="https://www.youtube.com/watch?v=xY96v0OIcK4" target="_blank" class="py-4 p-3">
              <button class="btn btn-block btn-outline-primary italic">Part 1 - Launch to ISS</button>
            </a>
            <a href="https://www.youtube.com/watch?v=sl2jo1bSxl8" target="_blank" class="py-4 p-3">
              <button class="btn btn-block btn-outline-primary italic">Part 2 - Returning Home</button>
            </a>
          </div>
          <hr />
          <p class="text-center">
