<template>
  <div class="ULA-NextLaunch my-4 mx-4">
        ...
        <div class="row mx-1">
          <div class="col-md-5 col-sm-12 text-center">
            <img
              ...
              this.results.results[0].mission.name != null ||
            undefined
              ? 'ULAs next launch / mission is named ' + this.results.results[0].mission.name
...
<script>
var url =
  "https://lldev.thespacedevs.com/2.0.0/launch/upcoming/?format=json&limit=1&rocket__configuration__manufacturer__name__icontains=United+Launch+Alliance";
